...
namespace Google.ProtocolBuffers.DescriptorProtos {
  ...
  public static partial class DescriptorProtoFile {
    ...
    static DescriptorProtoFile() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          ...
          "byKpAwoPRGVzY3JpcHRvclByb3RvEgwKBG5hbWUYASABKAkSNAoFZmllbGQY" + 
          ...
          "b3RvLkV4dGVuc2lvblJhbmdlEjAKB29wdGlvbnMYByABKAsyHy5nb29nbGUu" + 
          "cHJvdG9idWYuTWVzc2FnZU9wdGlvbnMaLAoORXh0ZW5zaW9uUmFuZ2USDQoF" + 
          "c3RhcnQYASABKAUSCwoDZW5kGAIgASgFIrEFChRGaWVsZERlc2NyaXB0b3JQ" + 
          "cm90bxIMCgRuYW1lGAEgASgJEg4KBm51bWJlchgDIAEoBRJKCgVsYWJlbBgE" + 
          "IAEoDjIrLmdvb2dsZS5wcm90b2J1Zi5GaWVsZERlc2NyaXB0b3JQcm90by5M" + 
          "YWJlbDoOTEFCRUxfT1BUSU9OQUwSRQoEdHlwZRgFIAEoDjIqLmdvb2dsZS5w" + 
          "cm90b2J1Zi5GaWVsZERlc2NyaXB0b3JQcm90by5UeXBlOgtUWVBFX0RPVUJM" + 
          "RRIRCgl0eXBlX25hbWUYBiABKAkSEAoIZXh0ZW5kZWUYAiABKAkSFQoNZGVm" + 
          "YXVsdF92YWx1ZRgHIAEoCRIuCgdvcHRpb25zGAggASgLMh0uZ29vZ2xlLnBy" + 
          "b3RvYnVmLkZpZWxkT3B0aW9ucyK2AgoEVHlwZRIPCgtUWVBFX0RPVUJMRRAB" + 
          "Eg4KClRZUEVfRkxPQVQQAhIOCgpUWVBFX0lOVDY0EAMSDwoLVFlQRV9VSU5U" + 
          "NjQQBBIOCgpUWVBFX0lOVDMyEAUSEAoMVFlQRV9GSVhFRDY0EAYSEAoMVFlQ" + 
          "RV9GSVhFRDMyEAcSDQoJVFlQRV9CT09MEAgSDwoLVFlQRV9TVFJJTkcQCRIO" + 
          "CgpUWVBFX0dST1VQEAoSEAoMVFlQRV9NRVNTQUdFEAsSDgoKVFlQRV9CWVRF" + 
          "UxAMEg8KC1RZUEVfVUlOVDMyEA0SDQoJVFlQRV9FTlVNEA4SEQoNVFlQRV9T" + 
          "RklYRUQzMhAPEhEKDVRZUEVfU0ZJWEVENjQQEBIPCgtUWVBFX1NJTlQzMhAR" + 
          "Eg8KC1RZUEVfU0lOVDY0EBIiQwoFTGFiZWwSEgoOTEFCRUxfT1BUSU9OQUwQ" + 
          "ARISCg5MQUJFTF9SRVFVSVJFRBACEhIKDkxBQkVMX1JFUEVBVEVEEAMijAEK" + 
          "E0VudW1EZXNjcmlwdG9yUHJvdG8SDAoEbmFtZRgBIAEoCRI4CgV2YWx1ZRgC" + 
          "IAMoCzIpLmdvb2dsZS5wcm90b2J1Zi5FbnVtVmFsdWVEZXNjcmlwdG9yUHJv" + 
          "dG8SLQoHb3B0aW9ucxgDIAEoCzIcLmdvb2dsZS5wcm90b2J1Zi5FbnVtT3B0" + 
          "aW9ucyJsChhFbnVtVmFsdWVEZXNjcmlwdG9yUHJvdG8SDAoEbmFtZRgBIAEo" + 
          "CRIOCgZudW1iZXIYAiABKAUSMgoHb3B0aW9ucxgDIAEoCzIhLmdvb2dsZS5w" + 
          "cm90b2J1Zi5FbnVtVmFsdWVPcHRpb25zIpABChZTZXJ2aWNlRGVzY3JpcHRv" + 
          "clByb3RvEgwKBG5hbWUYASABKAkSNgoGbWV0aG9kGAIgAygLMiYuZ29vZ2xl" + 
          "LnByb3RvYnVmLk1ldGhvZERlc2NyaXB0b3JQcm90bxIwCgdvcHRpb25zGAMg" + 
          "ASgLMh8uZ29vZ2xlLnByb3RvYnVmLlNlcnZpY2VPcHRpb25zIn8KFU1ldGhv" + 
          "ZERlc2NyaXB0b3JQcm90bxIMCgRuYW1lGAEgASgJEhIKCmlucHV0X3R5cGUY" + 
          "AiABKAkSEwoLb3V0cHV0X3R5cGUYAyABKAkSLwoHb3B0aW9ucxgEIAEoCzIe" + 
          "Lmdvb2dsZS5wcm90b2J1Zi5NZXRob2RPcHRpb25zIukDCgtGaWxlT3B0aW9u" + 
          "cxIUCgxqYXZhX3BhY2thZ2UYASABKAkSHAoUamF2YV9vdXRlcl9jbGFzc25h" + 
          "bWUYCCABKAkSIgoTamF2YV9tdWx0aXBsZV9maWxlcxgKIAEoCDoFZmFsc2US" + 
          "LAodamF2YV9nZW5lcmF0ZV9lcXVhbHNfYW5kX2hhc2gYFCABKAg6BWZhbHNl" + 
          "EkYKDG9wdGltaXplX2ZvchgJIAEoDjIpLmdvb2dsZS5wcm90b2J1Zi5GaWxl" + 
          "T3B0aW9ucy5PcHRpbWl6ZU1vZGU6BVNQRUVEEhIKCmdvX3BhY2thZ2UYCyAB" + 
          "KAkSIgoTY2NfZ2VuZXJpY19zZXJ2aWNlcxgQIAEoCDoFZmFsc2USJAoVamF2" + 
          "YV9nZW5lcmljX3NlcnZpY2VzGBEgASgIOgVmYWxzZRIiChNweV9nZW5lcmlj" + 
          "X3NlcnZpY2VzGBIgASgIOgVmYWxzZRJDChR1bmludGVycHJldGVkX29wdGlv" + 
          "bhjnByADKAsyJC5nb29nbGUucHJvdG9idWYuVW5pbnRlcnByZXRlZE9wdGlv" + 
          "biI6CgxPcHRpbWl6ZU1vZGUSCQoFU1BFRUQQARINCglDT0RFX1NJWkUQAhIQ" + 
          "CgxMSVRFX1JVTlRJTUUQAyoJCOgHEICAgIACIrgBCg5NZXNzYWdlT3B0aW9u" + 
          ...
          "YnVmLlVuaW50ZXJwcmV0ZWRPcHRpb24qCQjoBxCAgICAAiK+AgoMRmllbGRP" + 
          "cHRpb25zEjoKBWN0eXBlGAEgASgOMiMuZ29vZ2xlLnByb3RvYnVmLkZpZWxk" + 
          "T3B0aW9ucy5DVHlwZToGU1RSSU5HEg4KBnBhY2tlZBgCIAEoCBITCgRsYXp5" + 
          "GAUgASgIOgVmYWxzZRIZCgpkZXByZWNhdGVkGAMgASgIOgVmYWxzZRIcChRl" + 
          "eHBlcmltZW50YWxfbWFwX2tleRgJIAEoCRITCgR3ZWFrGAogASgIOgVmYWxz" + 
          "ZRJDChR1bmludGVycHJldGVkX29wdGlvbhjnByADKAsyJC5nb29nbGUucHJv" + 
          "dG9idWYuVW5pbnRlcnByZXRlZE9wdGlvbiIvCgVDVHlwZRIKCgZTVFJJTkcQ" + 
          "ABIICgRDT1JEEAESEAoMU1RSSU5HX1BJRUNFEAIqCQjoBxCAgICAAiJ4CgtF" + 
          "bnVtT3B0aW9ucxIZCgthbGxvd19hbGlhcxgCIAEoCDoEdHJ1ZRJDChR1bmlu" + 
          "dGVycHJldGVkX29wdGlvbhjnByADKAsyJC5nb29nbGUucHJvdG9idWYuVW5p" + 
          "bnRlcnByZXRlZE9wdGlvbioJCOgHEICAgIACImIKEEVudW1WYWx1ZU9wdGlv" + 
          "bnMSQwoUdW5pbnRlcnByZXRlZF9vcHRpb24Y5wcgAygLMiQuZ29vZ2xlLnBy" + 
          "b3RvYnVmLlVuaW50ZXJwcmV0ZWRPcHRpb24qCQjoBxCAgICAAiJgCg5TZXJ2" + 
          "aWNlT3B0aW9ucxJDChR1bmludGVycHJldGVkX29wdGlvbhjnByADKAsyJC5n" + 
          "b29nbGUucHJvdG9idWYuVW5pbnRlcnByZXRlZE9wdGlvbioJCOgHEICAgIAC" + 
          "Il8KDU1ldGhvZE9wdGlvbnMSQwoUdW5pbnRlcnByZXRlZF9vcHRpb24Y5wcg" + 
          ...
          "IAIoCRIUCgxpc19leHRlbnNpb24YAiACKAgisQEKDlNvdXJjZUNvZGVJbmZv" + 
          "EjoKCGxvY2F0aW9uGAEgAygLMiguZ29vZ2xlLnByb3RvYnVmLlNvdXJjZUNv" + 
          "ZGVJbmZvLkxvY2F0aW9uGmMKCExvY2F0aW9uEhAKBHBhdGgYASADKAVCAhAB" + 
          "EhAKBHNwYW4YAiADKAVCAhABEhgKEGxlYWRpbmdfY29tbWVudHMYAyABKAkS" + 
          "GQoRdHJhaWxpbmdfY29tbWVudHMYBCABKAlCJwoTY29tLmdvb2dsZS5wcm90" + 
          "b2J1ZkIQRGVzY3JpcHRvclByb3Rvcw==");
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_google_protobuf_FileOptions__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Google.ProtocolBuffers.DescriptorProtos.FileOptions, global::Google.ProtocolBuffers.DescriptorProtos.FileOptions.Builder>(internal__static_google_protobuf_FileOptions__Descriptor,
                new string[] { "JavaPackage", "JavaOuterClassname", "JavaMultipleFiles", "JavaGenerateEqualsAndHash", "OptimizeFor", "GoPackage", "CcGenericServices", "JavaGenericServices", "PyGenericServices", "UninterpretedOption", });
        ...
        internal__static_google_protobuf_FieldOptions__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Google.ProtocolBuffers.DescriptorProtos.FieldOptions, global::Google.ProtocolBuffers.DescriptorProtos.FieldOptions.Builder>(internal__static_google_protobuf_FieldOptions__Descriptor,
                new string[] { "Ctype", "Packed", "Lazy", "Deprecated", "ExperimentalMapKey", "Weak", "UninterpretedOption", });
        ...
        internal__static_google_protobuf_EnumOptions__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::Google.ProtocolBuffers.DescriptorProtos.EnumOptions, global::Google.ProtocolBuffers.DescriptorProtos.EnumOptions.Builder>(internal__static_google_protobuf_EnumOptions__Descriptor,
                new string[] { "AllowAlias", "UninterpretedOption", });
  ...
  public sealed partial class FileDescriptorProto : pb::GeneratedMessage<FileDescriptorProto, FileDescriptorProto.Builder> {
    ...
    private static readonly uint[] _fileDescriptorProtoFieldTags = new uint[] { 26, 42, 58, 34, 10, 66, 18, 80, 50, 74, 88 };
  ...
  public sealed partial class FileOptions : pb::ExtendableMessage<FileOptions, FileOptions.Builder> {
    ...
    private static readonly uint[] _fileOptionsFieldTags = new uint[] { 128, 90, 160, 136, 80, 66, 10, 72, 144, 7994 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasJavaPackage) {
        output.WriteString(1, field_names[6], JavaPackage);
      }
      if (hasJavaOuterClassname) {
        output.WriteString(8, field_names[5], JavaOuterClassname);
      }
      if (hasOptimizeFor) {
        output.WriteEnum(9, field_names[7], (int) OptimizeFor, OptimizeFor);
      }
      if (hasJavaMultipleFiles) {
        output.WriteBool(10, field_names[4], JavaMultipleFiles);
      }
      if (hasGoPackage) {
        output.WriteString(11, field_names[1], GoPackage);
      }
      if (hasCcGenericServices) {
        output.WriteBool(16, field_names[0], CcGenericServices);
      }
      if (hasJavaGenericServices) {
        output.WriteBool(17, field_names[3], JavaGenericServices);
      }
      if (hasPyGenericServices) {
        output.WriteBool(18, field_names[8], PyGenericServices);
      }
      if (hasJavaGenerateEqualsAndHash) {
        output.WriteBool(20, field_names[2], JavaGenerateEqualsAndHash);
      }
  ...
  public sealed partial class FieldOptions : pb::ExtendableMessage<FieldOptions, FieldOptions.Builder> {
    ...
    private static readonly uint[] _fieldOptionsFieldTags = new uint[] { 8, 24, 74, 40, 16, 7994, 80 };
  ...
  public sealed partial class EnumOptions : pb::ExtendableMessage<EnumOptions, EnumOptions.Builder> {
    ...
    private static readonly uint[] _enumOptionsFieldTags = new uint[] { 16, 7994 };
  ...
  public sealed partial class SourceCodeInfo : pb::GeneratedMessage<SourceCodeInfo, SourceCodeInfo.Builder> {
    ...
    public static partial class Types {
      ...
      public sealed partial class Location : pb::GeneratedMessage<Location, Location.Builder> {
        ...
        private static readonly uint[] _locationFieldTags = new uint[] { 26, 10, 18, 34 };
        ...
        public override void WriteTo(pb::ICodedOutputStream output) {
          ...
          if (hasTrailingComments) {
            output.WriteString(4, field_names[3], TrailingComments);
          }
          UnknownFields.WriteTo(output);
        }
